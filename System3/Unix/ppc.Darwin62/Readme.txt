This is the ETH Oberon System release 2.4 for MacOS X/Darwin.


Installation:
-------------
  The Oberon system for MacOS X is an X-Windows program. To use it you
have to install and start XDarwin first. Then perform the following
steps in one of the xterm windows of XDarwin:
...
1.      Create a home directory for the Oberon System at an
        ...
        The users get only read permissions to the files in this
        directory!
...
2.      Unpack the System
        ...
        as root:
           ./inst.oberon  ppc_Darwin_Oberon_r24_Sys.tgz /home/oberon /usr/local/bin/oberon

           (The 3. parameter is the name of the oberon start script to be installed)

3.	as root:
	   cd /home/oberon
	   chown root macx.oberon
	   chmod 4755 macx.oberon

4.      Create a directory in which you want to work with Oberon 
